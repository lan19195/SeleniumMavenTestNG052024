...
import com.lantester.Bai10_Annonations.DemoAnnotaion;
...
public class DemoActionsClass extends BaseTest {
      ...
      public void TestPressEnterKey() {
            ...
            WebElement elementTitlePage = driver.findElement(By.xpath("(//h3[normalize-space()='Anh Tester Automation Testing'])[1]"));
      ...
      public void inputTextUppercase() throws InterruptedException {
            driver.get("https://www.google.com/");
            Thread.sleep(2000);
            WebElement element = driver.findElement(By.xpath("//textarea[@name='q']")); //hoặc //*[@name='q']
