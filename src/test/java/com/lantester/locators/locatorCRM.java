package com.lantester.locators;
...
public class locatorCRM {
      ...
      public static String inputSearchCustomers = "//input[@class='form-control input-sm']";
      ...
      public static String inputSearchContact = "//input[@class='form-control input-sm']";
      ...
      public static String buttonSave = "//form[@id='contact-form']//button[normalize-space()='Save']";
